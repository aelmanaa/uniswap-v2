...
import { toWei, bigNumberify } from '../utils/shared';
import { getApprovalDigest } from '../utils/shared';
import { MockUniswapV2ERC20__factory } from '../../typechain-types/factories/contracts/test';
...
describe('UniswapV2ERC20', () => {
  const deployTokenFixture = async () => {
    ...
    const MockUniswapV2ERC20 = (await ethers.getContractFactory('MockUniswapV2ERC20')) as MockUniswapV2ERC20__factory;
    const token = await MockUniswapV2ERC20.deploy(TOTAL_SUPPLY);
